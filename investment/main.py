...
#vis.close(env='main')
app = dash.Dash(suppress_callback_exceptions=True, external_stylesheets=[dbc.themes.BOOTSTRAP], assets_folder=os.path.join(os.getcwd(), '.fmlops', 'monitoring_source'))
...
TAB2.RC00.values = html.Img(src=app.get_asset_url('awef.png'))

"""
html.Div([dbc.Button('A', color='dark', href=""),
