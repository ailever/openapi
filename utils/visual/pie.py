...
main = dbc.Jumbotron([html.H2(html.A('pie', href="/")),
                      ...
                      html.Div([dbc.Button("Ailever", color="secondary", href='https://ailever.github.io/'),
                                dbc.Button("Source", color="secondary", href='https://github.com/ailever/openapi/blob/master/utils/visual/pie.py'),
                      ...
                      html.Div([dbc.Button('dash-html', color='dark', href="https://dash.plotly.com/dash-html-components/"),
                                ...
                                dbc.Button('API(GO)', color='danger', href="https://plotly.com/python-api-reference/generated/plotly.graph_objects.Pie.html"),
                                dbc.Button('API(PX)', color='danger', href="https://plotly.com/python-api-reference/generated/plotly.express.pie.html"),                                
                                dbc.Button('Example', color='danger', href="https://plotly.com/python/pie-charts/")]),
