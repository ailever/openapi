...
O = {}
O['T,_,_'] = None
O['T,0,0'] = dcc.Markdown(minutes.date)
O['T,1,0'] = dcc.Markdown(minutes.place)
...
main = dbc.Jumbotron([html.H2('minutes'),
                      ...
                      html.Div([dbc.Button("Home", color="secondary", href='https://ailever.github.io/'),
                                dbc.Button("Source", color="secondary", href='https://github.com/ailever/openapi/tree/master/utils/minutes.py'),
