...
main = dbc.Jumbotron([html.H2(html.A('utils', href="/")),
                      ...
                      html.Div([dbc.Button("Ailever", color="secondary", href='https://ailever.github.io/'),
                                dbc.Button("Source", color="secondary", href='https://github.com/ailever/openapi/blob/master/utils/main.py'),
                                dbc.Button("Notion", color="secondary", href="https://www.notion.so/UTILS-DASHBOARD-c80caac499964d648c071b634cc98121"),                                
