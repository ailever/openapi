...
data = [[37.586786, 126.974736, '청와대(Cheong Wh Dae)', '서울(Seoul)', "종로구 세종로"],
        ...
        [37.545534365123046, 126.9445712830084, '한국중견기업연합회(Federation of Middle Market Enterprises of Korea)', '서울(Seoul)', '마포구 대흥동'],
        [37.486869191907694, 126.90606444067956,'소상공인연합회(Korea Federation of Micro Enterprise)', '서울(Seoul)', '동작구 신대방동'],
        [37.56510714476617, 126.98540256951776, '전국은행연합회(Korea Federation of Banks)', '서울(Seoul)', '중구 명동1가'],
