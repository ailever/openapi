...
main = dbc.Jumbotron([html.H2('captioning - template'),
                      ...
                      html.Div([dbc.Button("Home", color="secondary", href='https://ailever.github.io/'),
                                dbc.Button("Source", color="secondary", href='https://github.com/ailever/openapi/tree/master/captioning/_template.py'),
